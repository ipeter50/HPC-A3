...
__global__ void update_jacobi_2gpu0(double *d_Uk, double *d_Ukbot, double *d_Uk1, double *d_F, int N, double delta_squared, double h);
__global__ void update_jacobi_2gpu1(double *d_Uk, double *d_Uktop, double *d_Uk1, double *d_F, int N, double delta_squared, double h);
